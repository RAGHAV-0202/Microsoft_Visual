...
function Footer() {
  return (
    <div  className="  w-full h-[auto] flex flex-col px-10 pt-20 font-black text-black bg-[#F1F1F1] gap-20">

        <div className="w-full h-[90vh flex flex-row">

            <div className="w-[40%] h-full ">
                <h1 className="text-[8vw] font-['Founders'] leading-none ">EYE-</h1>
                <h1 className="text-[8vw] font-['Founders'] leading-none ">OPENING</h1>
            </div>
            <div className="w-[60%] h-full  flex flex-col">
                <h1 className="text-[8vw] font-['Founders'] leading-none pb-10 ">PRESENTATIONS</h1>
                <h6 className="font-medium pb-5">S:</h6>
                    <a className="capitalize font-thin underline pl-5 " href="#">INSTGRAM</a>
                    <a className="capitalize font-thin underline pl-5 " href="#">youtube</a>
                    <a className="capitalize font-thin underline pl-5 " href="#">facebook</a>
                    <a className="capitalize font-thin underline pl-5 " href="#">linkedin</a>

                <h6 className="font-medium pb-5 pt-10">L:</h6>
                    <a className="capitalize font-thin underline pl-5 " href="#">202-1965 W 4th Ave</a>
                    <a className="capitalize font-thin underline pl-5 " href="#">Vancouver, Canada</a>
                    <a className="capitalize font-thin underline pl-5 " href="#">30 Chukarina St</a>
                    <a className="capitalize font-thin underline pl-5 " href="#">Lviv, Ukraine</a>
            </div>
        </div>
        ...
        <div className="w-full h-[10vh]  flex flex-row items-center justify-between">
            ...
            <p className="font-thin text-[14px] text-zinc-400">&copy; ochi design 2025</p> 

            <p className="font-thin text-[14px] text-zinc-400">Website by Raghav</p>  
        </div>
